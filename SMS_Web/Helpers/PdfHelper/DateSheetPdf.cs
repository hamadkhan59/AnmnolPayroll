...
{
    public class DateSheetPdf : BasicPdf
    {
        private SC_WEBEntities2 db = SessionHelper.dbContext;

        public PdfDocument createDateSheet(int[] subjectIds, string className, string sectionName, string examName, DateTime[] ExamDate, string[] startTimes, string[] endTimes, string[] Center, string[] SubjectName, PdfDocument pdfdoc, StudentModel student)
        {
            try
            {
                ...
                grph.DrawRectangle(XPens.RoyalBlue, 40, 150, 150, 20);
                grph.DrawRectangle(XPens.RoyalBlue, 190, 150, 185, 20);
                grph.DrawRectangle(XPens.RoyalBlue, 375, 150, 185, 20);
                //grph.DrawRectangle(XPens.RoyalBlue, 97, 127, 426, 26);
                ...
                grph.DrawString("Student Name : " + student.Name, font, XBrushes.Black, new XRect(50, 135, page.Width.Point, page.Height.Point), XStringFormats.TopLeft);
                grph.DrawString("Father Name : " + student.FatherName, font, XBrushes.Black, new XRect(305, 135, page.Width.Point, page.Height.Point), XStringFormats.TopLeft);
                //font = new XFont("Verdana", 10, XFontStyle.Regular);
                grph.DrawString("Admission No : " + student.AdmissionNo, font, XBrushes.Black, new XRect(50, 155, page.Width.Point, page.Height.Point), XStringFormats.TopLeft);
                grph.DrawString("Class : " + className, font, XBrushes.Black, new XRect(200, 155, page.Width.Point, page.Height.Point), XStringFormats.TopLeft);
                grph.DrawString("Section : " + sectionName, font, XBrushes.Black, new XRect(385, 155, page.Width.Point, page.Height.Point), XStringFormats.TopLeft);
                ...
                DateSheetConfig config = db.DateSheetConfigs.Where(x => x.BranchId == student.BranchId).FirstOrDefault();
                ...
                base.DrawPrincipalSignature(grph, page, 435, (int)page.Height - 110, student.BranchId);
                ...
                DesignSchoolHeader(grph, page, student.BranchId);
        ...
        public PdfDocument createDateSheet(int[] subjectIds, string className, string sectionName, string examName, DateTime[] ExamDate, string[] startTimes, string[] endTimes, string[] Center, string[] SubjectName, PdfDocument pdfdoc, StudentModel student, List<int> classSubjectsIds)
        {
            try
            {
                LogWriter.WriteProcStartLog(this.GetType().Name, MethodBase.GetCurrentMethod().Name);
        ...
        private void DesignSchoolHeader(XGraphics grph, PdfPage page, int branchId)
        {
            try
            {
                ...
                grph.DrawImage((Bitmap)tc.ConvertFrom((byte[])db.SchoolConfigs.Find(1).SchoolLogo), 25, 25);
