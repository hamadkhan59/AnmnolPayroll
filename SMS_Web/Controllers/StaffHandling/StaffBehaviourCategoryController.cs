...
{
    public class StaffBehaviourCategoryController : Controller
    {
        ...
        public StaffBehaviourCategoryController()
        {
        ...
        public ActionResult Index( int id = 0)
        {
            ...
            if (UserPermissionController.CheckUserPermission(Session.SessionID, ConstHelper.SH_BEH_CAT) == false)
            {
                return RedirectToAction("Index", "NoPermission");
            }

            StaffBehaviourCategory clas = new StaffBehaviourCategory();
        ...
        public ActionResult CreateOrUpdate(StaffBehaviourCategory category)
        {
            if (UserPermissionController.CheckUserLoginStatus(Session.SessionID) == false)
            {
                return RedirectToAction("Index", "Login");
            ...
            try
            {
                ...
                {
                    LogWriter.WriteLog("Model state is valid, creating or updating the staff behaviour categpry");
