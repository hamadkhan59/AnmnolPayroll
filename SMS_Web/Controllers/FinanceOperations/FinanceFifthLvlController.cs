...
{
    public class FinanceFifthLvlController : Controller
    {
        ...
        public FinanceFifthLvlController()
        {
        ...
        public ActionResult Index(int id = 0)
        {
            ...
            if (UserPermissionController.CheckUserPermission(Session.SessionID, ConstHelper.FA_FINANCE_DETAIL_ACCOUNT) == false)
            {
            ...
            try
            {
                ...
                ViewBag.FourthLvlAccountId = new SelectList(SessionHelper.FinanceFourthLvlAccountList(Session.SessionID), "Id", "AccountName", accountId);
                if (id > 0)
                    errorCode = 0;
