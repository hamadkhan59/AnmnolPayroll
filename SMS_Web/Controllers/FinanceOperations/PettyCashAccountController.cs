...
{
    public class PettyCashAccountController : Controller
    {
        ...
        public PettyCashAccountController()
        {
        ...
        public ActionResult Index(int id = 0)
        {
            ...
            if (UserPermissionController.CheckUserPermission(Session.SessionID, ConstHelper.PC_PETTY_ACCOUNTS) == false)
            {
            ...
            try
            {
                ...
                ViewBag.FourthLvlAccountId = new SelectList(SessionHelper.PettyCashFourthLvlAccounts(Session.SessionID), "Id", "AccountName", accountId);
                if (id > 0)
                    errorCode = 0;
        ...
        public ActionResult Create(FinanceFifthLvlAccount fifthLvlAccount)
        {
            ...
            try
            {
                ...
                var classObj = accountRepo.GetPettyCashFinanceFifthLvlAccountByName(fifthLvlAccount.AccountName, branchId);
                if (ModelState.IsValid && classObj == null && !string.IsNullOrEmpty(fifthLvlAccount.AccountName))
                {
                    ...
                    fifthLvlAccount.IsPettyCashAccount = true;
        ...
        public ActionResult Edit(FinanceFifthLvlAccount fifthLvlAccount)
        {
            ...
            try
            {
                ...
                fifthLvlAccount.FourthLvlAccountId = fifthLvlAccount.FinanceFourthLvlAccount.Id;
                int branchId = UserPermissionController.GetLoginBranchId(Session.SessionID);
                var classObj = accountRepo.GetPettCashFinanceFifthLvlAccountByNameAndId(fifthLvlAccount.AccountName, fifthLvlAccount.Id, branchId);
