...
namespace SMS_Web.MakeClassSchedule.Algorithm
{
    ...
    public class Algorithm
    {
        ...
        public bool Start()
        {
            ...
            if (false) // Single Process for GA
            {
            ...
            //
            if (true) // Multi Process //ResultControls.ResultForm._setting.Parallel_Process
            {
        ...
        public void Stop()
        {
            if (_state == AlgorithmState.AS_RUNNING)
            {
                ...
                for (int cpu = 0; cpu < MultiThreads.Count(); cpu++)
